...
Thuật toán này là một sự kết hợp tuyệt vời của Selection Sort và Bubble Sort. Mặc dù không ai đặt tên cho nó, nhưng nó xứng đáng được nhớ đến vì sự tiện lợi và đơn giản bậc nhất của nó. Người viết tạm đặt cho thuật toán này cái tên `"Easy Sort"` - một thuật toán siêu dễ nhớ, đặc biệt phù hợp với sự lười của người code.
